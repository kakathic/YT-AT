...
Kad=Auto
V=U
[ "$(Xem https://github.com/kakathic/YT-AT/releases/download/Up/Up-Z$V$ach$amoled2.json | grep -cm1 "${VER//./}")" == 1 ] && (echo; echo "- Là phiên bản mới nhất."; exit 0;)
else
VER="$VERSION"
Kad=News
V=N
...
version='$VER'
versionCode='${VER//./}'
updateJson=https://github.com/kakathic/'$GITHUB_REPOSITORY'/releases/download/Up/Up-Z'$V$ach$amoled2'.json
